...
@RunWith(SpringRunner.class) // для запуска теста используется не стандартный junit runner, а spring runner
@ContextConfiguration(locations = {"classpath:springContext.xml"}) //указываем, где находятся файлы для подключения
public class StudentServiceTest {
    ...
    public void studentInfo(){
        ...
        // есть хотя бы одна запись с данными параметрами
