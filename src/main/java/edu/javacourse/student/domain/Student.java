...
@Table(name = "sr_student") // таблица данной сущности
@Entity
public class Student {

    @Id// поле-идентификатор
    // генерация идентификатора (IDENTITY - при добавлении объекта в таблицу,
    // автогенерирование Id, т.к. в Postgres есть автогенерация полей)
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "student_id") // название колонки в БД, на которую отображается поле
    ...
    // студенческие билеты (StudentDocument), которыми обладает студент
